...
public static class RandomGamePicker
{
    ...
    /// </summary>
    static readonly Random randomizer = new((int)DateTime.Now.ToBinary());
    ...
    public static GameModel SelectRandomGameWithWeights(params string[] gameNames)
    {
        ...
        List<GameModel> weightedList = new();
    ...
    /// </summary>
    public static string[] GameList => GameLibrary.HoboGameLibrary.Count > 0 ? GameLibrary.HoboGameLibrary.Select(game => game.Title).ToArray() : Array.Empty<string>();
}
