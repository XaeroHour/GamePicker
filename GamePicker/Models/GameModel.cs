...
namespace GamePicker
{
    ...
    public class GameModel : IComparable
    {
        ...
        {
            return string.Equals(this.Title, ((GameModel)obj)?.Title, StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            return this.Title.CompareTo(((GameModel)obj).Title);
        }
    }
}
